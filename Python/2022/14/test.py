...
def soln_1():
    ...
    sand_drip:list = [500, 0]
    # memoization of the path the sand took
    sand_stack:deque = deque()
    sand_stack.append(sand_drip)

    reached_abyss:bool = False
    # keeps going if not not in abyss
    sand_location = sand_drip
    while not reached_abyss:
        sand_live:bool = True
        while (sand_live):
            # adds movement to stack
            sand_stack.append(sand_location.copy())
        ...
        sand_location:list = sand_stack.pop()   
